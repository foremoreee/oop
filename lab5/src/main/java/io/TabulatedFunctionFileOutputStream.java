...
public class TabulatedFunctionFileOutputStream {
    public static void main(String[] args) {
        ...
        try (BufferedOutputStream bufferedOutputStream1 = new BufferedOutputStream(new FileOutputStream("C:\\Users\\ilham\\IdeaProjects\\lab_5\\output/array function.bin"));
             BufferedOutputStream bufferedOutputStream2 = new BufferedOutputStream(new FileOutputStream("C:\\Users\\ilham\\IdeaProjects\\lab_5\\output/linked list function.bin"))) {
